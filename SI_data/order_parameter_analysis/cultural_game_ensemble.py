...
def define_environment(model, params):
    ...
    env.newPropertyFloat("segregation_index_type", 0.0)     # Segregation based on cultural type (Overall Average Same Type Neighbor Proportion)
    ...
    # **NEW** Properties for group-specific metrics (4 types)
    # Type 1 (0 <= C < 0.25)
    env.newPropertyUInt("total_cooperators_type_1", 0)
    env.newPropertyUInt("total_count_type_1", 0)
    env.newPropertyUInt("total_same_type_neighbors_type_1", 0)
    env.newPropertyUInt("total_neighbors_count_type_1", 0)
    env.newPropertyFloat("coop_rate_type_1", 0.0)
    env.newPropertyFloat("segregation_index_type_1", 0.0)

    # Type 2 (0.25 <= C < 0.5)
    env.newPropertyUInt("total_cooperators_type_2", 0)
    env.newPropertyUInt("total_count_type_2", 0)
    env.newPropertyUInt("total_same_type_neighbors_type_2", 0)
    env.newPropertyUInt("total_neighbors_count_type_2", 0)
    env.newPropertyFloat("coop_rate_type_2", 0.0)
    env.newPropertyFloat("segregation_index_type_2", 0.0)

    # Type 3 (0.5 <= C < 0.75)
    env.newPropertyUInt("total_cooperators_type_3", 0)
    env.newPropertyUInt("total_count_type_3", 0)
    env.newPropertyUInt("total_same_type_neighbors_type_3", 0)
    env.newPropertyUInt("total_neighbors_count_type_3", 0)
    env.newPropertyFloat("coop_rate_type_3", 0.0)
    env.newPropertyFloat("segregation_index_type_3", 0.0)

    # Type 4 (0.75 <= C <= 1.0)
    env.newPropertyUInt("total_cooperators_type_4", 0)
    env.newPropertyUInt("total_count_type_4", 0)
    env.newPropertyUInt("total_same_type_neighbors_type_4", 0)
    env.newPropertyUInt("total_neighbors_count_type_4", 0)
    env.newPropertyFloat("coop_rate_type_4", 0.0)
    env.newPropertyFloat("segregation_index_type_4", 0.0)
...
def define_agents(model):
    ...
    agent.newVariableUInt("same_type_neighbors", 0)     # Count of neighbors with same cultural type (Overall)
    ...
    agent.newVariableUInt("agent_type", 0)              # 1-4 for the four types

    # **NEW** Agent variables for group-specific metrics (for reduction)
    # These are used by calculate_local_metrics_func and summed in StepFunction
    agent.newVariableUInt("cooperator_type_1", 0)
    agent.newVariableUInt("cooperator_type_2", 0)
    agent.newVariableUInt("cooperator_type_3", 0)
    agent.newVariableUInt("cooperator_type_4", 0)
    agent.newVariableUInt("count_type_1", 0)
    agent.newVariableUInt("count_type_2", 0)
    agent.newVariableUInt("count_type_3", 0)
    agent.newVariableUInt("count_type_4", 0)
    agent.newVariableUInt("same_type_neighbors_type_1", 0)
    agent.newVariableUInt("same_type_neighbors_type_2", 0)
    agent.newVariableUInt("same_type_neighbors_type_3", 0)
    agent.newVariableUInt("same_type_neighbors_type_4", 0)
    agent.newVariableUInt("total_neighbors_count_type_1", 0)
    agent.newVariableUInt("total_neighbors_count_type_2", 0)
    agent.newVariableUInt("total_neighbors_count_type_3", 0)
    agent.newVariableUInt("total_neighbors_count_type_4", 0)
...
class InitFunction(pyflamegpu.HostFunction):
    ...
    def run(self, FLAMEGPU):
        ...
        for i in range(agent_count):
            ...
            # Initialize new group-specific variables (for reduction)
            agent.setVariableUInt("cooperator_type_1", 0)
            agent.setVariableUInt("cooperator_type_2", 0)
            agent.setVariableUInt("cooperator_type_3", 0)
            agent.setVariableUInt("cooperator_type_4", 0)
            agent.setVariableUInt("count_type_1", 0)
            agent.setVariableUInt("count_type_2", 0)
            agent.setVariableUInt("count_type_3", 0)
            agent.setVariableUInt("count_type_4", 0)
            agent.setVariableUInt("same_type_neighbors_type_1", 0)
            agent.setVariableUInt("same_type_neighbors_type_2", 0)
            agent.setVariableUInt("same_type_neighbors_type_3", 0)
            agent.setVariableUInt("same_type_neighbors_type_4", 0)
            agent.setVariableUInt("total_neighbors_count_type_1", 0)
            agent.setVariableUInt("total_neighbors_count_type_2", 0)
            agent.setVariableUInt("total_neighbors_count_type_3", 0)
            agent.setVariableUInt("total_neighbors_count_type_4", 0)
...
class StepFunction(pyflamegpu.HostFunction):
    ...
    def run(self, FLAMEGPU):
        ...
        # --- Calculate Group-Specific Metrics (4 types) ---
        # Type 1 (0 <= C < 0.25)
        total_cooperators_type_1 = FLAMEGPU.agent("CulturalAgent").sumUInt("cooperator_type_1")
        total_count_type_1 = FLAMEGPU.agent("CulturalAgent").sumUInt("count_type_1")
        total_same_type_neighbors_type_1 = FLAMEGPU.agent("CulturalAgent").sumUInt("same_type_neighbors_type_1")
        total_neighbors_count_type_1 = FLAMEGPU.agent("CulturalAgent").sumUInt("total_neighbors_count_type_1")
        FLAMEGPU.environment.setPropertyUInt("total_cooperators_type_1", total_cooperators_type_1)
        FLAMEGPU.environment.setPropertyUInt("total_count_type_1", total_count_type_1)
        FLAMEGPU.environment.setPropertyUInt("total_same_type_neighbors_type_1", total_same_type_neighbors_type_1)
        FLAMEGPU.environment.setPropertyUInt("total_neighbors_count_type_1", total_neighbors_count_type_1)
        if total_count_type_1 > 0:
            FLAMEGPU.environment.setPropertyFloat("coop_rate_type_1", float(total_cooperators_type_1) / total_count_type_1)
        else:
            FLAMEGPU.environment.setPropertyFloat("coop_rate_type_1", 0.0)
        if total_neighbors_count_type_1 > 0:
            FLAMEGPU.environment.setPropertyFloat("segregation_index_type_1", float(total_same_type_neighbors_type_1) / total_neighbors_count_type_1)
        else:
            FLAMEGPU.environment.setPropertyFloat("segregation_index_type_1", 0.0)

        # Type 2 (0.25 <= C < 0.5)
        total_cooperators_type_2 = FLAMEGPU.agent("CulturalAgent").sumUInt("cooperator_type_2")
        total_count_type_2 = FLAMEGPU.agent("CulturalAgent").sumUInt("count_type_2")
        total_same_type_neighbors_type_2 = FLAMEGPU.agent("CulturalAgent").sumUInt("same_type_neighbors_type_2")
        total_neighbors_count_type_2 = FLAMEGPU.agent("CulturalAgent").sumUInt("total_neighbors_count_type_2")
        FLAMEGPU.environment.setPropertyUInt("total_cooperators_type_2", total_cooperators_type_2)
        FLAMEGPU.environment.setPropertyUInt("total_count_type_2", total_count_type_2)
        FLAMEGPU.environment.setPropertyUInt("total_same_type_neighbors_type_2", total_same_type_neighbors_type_2)
        FLAMEGPU.environment.setPropertyUInt("total_neighbors_count_type_2", total_neighbors_count_type_2)
        if total_count_type_2 > 0:
            FLAMEGPU.environment.setPropertyFloat("coop_rate_type_2", float(total_cooperators_type_2) / total_count_type_2)
        else:
            FLAMEGPU.environment.setPropertyFloat("coop_rate_type_2", 0.0)
        if total_neighbors_count_type_2 > 0:
            FLAMEGPU.environment.setPropertyFloat("segregation_index_type_2", float(total_same_type_neighbors_type_2) / total_neighbors_count_type_2)
        else:
            FLAMEGPU.environment.setPropertyFloat("segregation_index_type_2", 0.0)

        # Type 3 (0.5 <= C < 0.75)
        total_cooperators_type_3 = FLAMEGPU.agent("CulturalAgent").sumUInt("cooperator_type_3")
        total_count_type_3 = FLAMEGPU.agent("CulturalAgent").sumUInt("count_type_3")
        total_same_type_neighbors_type_3 = FLAMEGPU.agent("CulturalAgent").sumUInt("same_type_neighbors_type_3")
        total_neighbors_count_type_3 = FLAMEGPU.agent("CulturalAgent").sumUInt("total_neighbors_count_type_3")
        FLAMEGPU.environment.setPropertyUInt("total_cooperators_type_3", total_cooperators_type_3)
        FLAMEGPU.environment.setPropertyUInt("total_count_type_3", total_count_type_3)
        FLAMEGPU.environment.setPropertyUInt("total_same_type_neighbors_type_3", total_same_type_neighbors_type_3)
        FLAMEGPU.environment.setPropertyUInt("total_neighbors_count_type_3", total_neighbors_count_type_3)
        if total_count_type_3 > 0:
            FLAMEGPU.environment.setPropertyFloat("coop_rate_type_3", float(total_cooperators_type_3) / total_count_type_3)
        else:
            FLAMEGPU.environment.setPropertyFloat("coop_rate_type_3", 0.0)
        if total_neighbors_count_type_3 > 0:
            FLAMEGPU.environment.setPropertyFloat("segregation_index_type_3", float(total_same_type_neighbors_type_3) / total_neighbors_count_type_3)
        else:
            FLAMEGPU.environment.setPropertyFloat("segregation_index_type_3", 0.0)

        # Type 4 (0.75 <= C <= 1.0)
        total_cooperators_type_4 = FLAMEGPU.agent("CulturalAgent").sumUInt("cooperator_type_4")
        total_count_type_4 = FLAMEGPU.agent("CulturalAgent").sumUInt("count_type_4")
        total_same_type_neighbors_type_4 = FLAMEGPU.agent("CulturalAgent").sumUInt("same_type_neighbors_type_4")
        total_neighbors_count_type_4 = FLAMEGPU.agent("CulturalAgent").sumUInt("total_neighbors_count_type_4")
        FLAMEGPU.environment.setPropertyUInt("total_cooperators_type_4", total_cooperators_type_4)
        FLAMEGPU.environment.setPropertyUInt("total_count_type_4", total_count_type_4)
        FLAMEGPU.environment.setPropertyUInt("total_same_type_neighbors_type_4", total_same_type_neighbors_type_4)
        FLAMEGPU.environment.setPropertyUInt("total_neighbors_count_type_4", total_neighbors_count_type_4)
        if total_count_type_4 > 0:
            FLAMEGPU.environment.setPropertyFloat("coop_rate_type_4", float(total_cooperators_type_4) / total_count_type_4)
        else:
            FLAMEGPU.environment.setPropertyFloat("coop_rate_type_4", 0.0)
        if total_neighbors_count_type_4 > 0:
            FLAMEGPU.environment.setPropertyFloat("segregation_index_type_4", float(total_same_type_neighbors_type_4) / total_neighbors_count_type_4)
        else:
            FLAMEGPU.environment.setPropertyFloat("segregation_index_type_4", 0.0)
...
def define_logs(model):
    ...
    # **NEW** Log group-specific metrics (4 types)
    log_cfg.logEnvironment("coop_rate_type_1")
    log_cfg.logEnvironment("coop_rate_type_2")
    log_cfg.logEnvironment("coop_rate_type_3")
    log_cfg.logEnvironment("coop_rate_type_4")
    log_cfg.logEnvironment("segregation_index_type_1")
    log_cfg.logEnvironment("segregation_index_type_2")
    log_cfg.logEnvironment("segregation_index_type_3")
    log_cfg.logEnvironment("segregation_index_type_4")
    ...
    # log_cfg.logEnvironment("total_cooperators_type_1")
    # log_cfg.logEnvironment("total_cooperators_type_2")
    # log_cfg.logEnvironment("total_cooperators_type_3")
    # log_cfg.logEnvironment("total_cooperators_type_4")
    # log_cfg.logEnvironment("total_count_type_1")
    # log_cfg.logEnvironment("total_count_type_2")
    # log_cfg.logEnvironment("total_count_type_3")
    # log_cfg.logEnvironment("total_count_type_4")
    # log_cfg.logEnvironment("total_same_type_neighbors_type_1")
    # log_cfg.logEnvironment("total_same_type_neighbors_type_2")
    # log_cfg.logEnvironment("total_same_type_neighbors_type_3")
    # log_cfg.logEnvironment("total_same_type_neighbors_type_4")
    # log_cfg.logEnvironment("total_neighbors_count_type_1")
    # log_cfg.logEnvironment("total_neighbors_count_type_2")
    # log_cfg.logEnvironment("total_neighbors_count_type_3")
    # log_cfg.logEnvironment("total_neighbors_count_type_4")
